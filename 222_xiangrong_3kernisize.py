...
class FerModel(object):
    ...
    def build_model(self):
        ...
        x = BatchNormalization()(x)
        x = Dropout(0.3)(x)
        x2 = SeparableConvolution2D(128, 3, padding='same', activation="relu",
                                    # depthwise_regularizer=regularizers.l2(self.weight_decay),
                                    # pointwise_regularizer=regularizers.l2(self.weight_decay),
        ...
        x = BatchNormalization()(x)
        x = Dropout(0.3)(x)
        x3 = SeparableConvolution2D(256, 3, padding='same', activation="relu",
                                   # depthwise_regularizer=regularizers.l2(self.weight_decay),
                                   # pointwise_regularizer=regularizers.l2(self.weight_decay),
        ...
        x = BatchNormalization()(x)
        x = Dropout(0.3)(x)
        x4 = SeparableConvolution2D(512, 3, padding='same', activation="relu",
                                    # depthwise_regularizer=regularizers.l2(self.weight_decay),
                                    # pointwise_regularizer=regularizers.l2(self.weight_decay),

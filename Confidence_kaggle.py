...
data = []
aaa = ['./confidenceFile/kaggle_new.csv','./confidenceFile/auc1.csv','./confidenceFile/my.csv','./confidenceFile/my.csv','./confidenceFile/my.csv']
...
plt.ylabel("Kaggle  test  set  classification  confidence", fontsize=20)
plt.tight_layout()
